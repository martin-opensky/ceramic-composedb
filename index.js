...
var MyComposite = /** @class */ (function () {
    function MyComposite() {
    }
    MyComposite.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ceramic, composite;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ceramic = new CeramicClient("http://localhost:7007");
                        return [4 /*yield*/, Composite.fromModels({
                                ceramic: ceramic,
                                models: [
                    ...
                    case 1:
                        composite = _a.sent();
                        return [4 /*yield*/, writeEncodedComposite(composite, "my-first-composite.json")];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    MyComposite.prototype.deploy = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ceramic, composite;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ceramic = new CeramicClient("http://localhost:7007");
                        return [4 /*yield*/, readEncodedComposite(ceramic, "my-first-composite.json")];
                    case 1:
                        composite = _a.sent();
